...
/**
 * <p>Java class for EmployeeDataSimpleByResponseMessage_sync complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EmployeeDataSimpleByResponseMessage_sync"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="EmployeeData" type="{http://sap.com/xi/A1S/Global}EmployeeDataResponseEmployee" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "EmployeeDataSimpleByResponseMessage_sync", propOrder = {
    "employeeData",
    "processingConditions",
    "log"
})
public class EmployeeDataSimpleByResponseMessageSync {

    @XmlElement(name = "EmployeeData")
    protected List<EmployeeDataResponseEmployee> employeeData;
     ...
     * {@link EmployeeDataResponseEmployee }
     * 
     * 
     */
    public List<EmployeeDataResponseEmployee> getEmployeeData() {
        if (employeeData == null) {
            employeeData = new ArrayList<EmployeeDataResponseEmployee>();
        }
