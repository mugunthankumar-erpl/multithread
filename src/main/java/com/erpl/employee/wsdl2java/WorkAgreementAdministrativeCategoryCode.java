...
@XmlType(name = "WorkAgreementAdministrativeCategoryCode", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {
    "value"
})
public class WorkAgreementAdministrativeCategoryCode {
